<template>
  <div class="root container w-50">
    ...
    <hr />
    <div
      class="row mt-5 mb-5 justify-content-around"
      style="margin-left: 50px; height: 280px"
    >
      <div class="col-5 mt-5">
        ...
        <span style="font-size: 1rem"
          >원하는 매물을 등록할 수 있습니다.<br />
          월 300만명이 부동산을 검색하는 맛동산에<br />
          매물을 노출하세요</span
        >
      </div>
      <div class="col-6">
        <img
          src="@/assets/paymentInfo.svg"
          class="card-img-top img-fluid mt-5 mt-3"
          alt="..."
        />
      </div>
    </div>
    ...
    <div class="products-box">
      <div>
        ...
        <ul class="row" style="padding-right: 32px">
          <li class="col p-0 px-2">
            <div class="card h-100">
              ...
              <p
                class="card-text mt-3 mb-0"
                style="font-weight: bold; font-size: 1.2rem"
              >
                등록 건 1개
              </p>
              <hr />
              <p style="font-weight: bold; font-size: 1.5rem; color: #326cf9">
                5,500원
              </p>
            </div>
          </li>
        ...
        <div
          class="btn btn-warning btn-lg w-50 container fw-bold mt-3"
    ...
    <div class="row mt-5 mb-5" style="margin-left: 50px; height: 260px">
      <div class="col-5 mt-5">
        ...
        <span style="font-size: 1rem"
          >맛동산 웹사이트의 모든 검색 결과에 노출됩니다.<br />
          검색되는 모든 결과에 노출되므로<br />등록 수량이 많을 수록 광고 효과가
          높아집니다.</span
        >
      </div>
      <div class="col-6 ms-5">
        <img
          src="@/assets/paymentInfo2.svg"
    ...
    <div class="info-box">
      ...
      <p style="font-size: small">
        광고 상품 및 이용에 대한 문의는 언제든지 고객센터에 문의해 주세요.
      </p>
      <RouterLink to="/QNA/Notice"
