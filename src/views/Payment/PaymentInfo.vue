<template>
    <div class="root container w-75">
        <div>
            <h2 style="font-weight: bold; text-align: center; margin-bottom: 30px; margin-top: 30px">매물 등록하기</h2>
        </div>
        <hr>
        <div class="row mt-5 mb-5" style="margin-left: 50px; height: 380px">
            <div class="col-5 mt-5">
                <p style="font-size: 2.1rem; font-weight: bold;">원하는 매물을<br> 등록할 수 있는 상품</p>
                <span style="font-size: 1.2rem;">원하는 매물을 등록할 수 있습니다.<br>
        ...
        <div class="products-box">
            <div>
                ...
                <ul class="row">
                    <li class="col-4">
                        <div class="card w-25%" style="height: 370px" >
                            <div style="margin-top: 64px; padding-top: 30px" >
                            <img class="w-25" src="@/assets/home.png" alt="" />
                            </div>
    
                            <p class="card-text mt-3 mb-0" style="font-weight: bold; font-size: 1.5rem;">등록 건 1개</p>
                            <hr>
                            <p style="font-weight: bold; font-size: 1.7rem; color: #326CF9;">5,500원</p>
                    ...
                    <li class="col-4">
                        <div class="card"  style="height: 370px">
                            ...
                            <p class="card-text mt-3 mb-0" style="font-weight: bold; font-size: 1.5rem;">등록 건 3개</p>
                            <hr>
                    ...
                    <li class="col-4">
                        <div class="card"  style="height: 370px">
                            <div class="mt-4">
                                <img class="w-25" src="@/assets/home.png" alt="" />
                                <img class="w-25" src="@/assets/home.png" alt="" /><br>
                                <img class="w-25" src="@/assets/home.png" alt="" />
                                <img class="w-25" src="@/assets/home.png" alt="" />
                                <img class="w-25" src="@/assets/home.png" alt="" />
                            </div>
    
                            <p class="card-text mt-3 mb-0" style="font-weight: bold; font-size: 1.5rem;">등록 건 5개</p>
                            <hr>
                            <p style="font-weight: bold; font-size: 1.7rem; color: #326CF9;">25,000원</p>
                            <RouterLink class="btn btn-warning w-50" style="margin-left: 70px; margin-bottom: 20px;" to="/Payment">구매하기</RouterLink>
                        </div>
                    </li>
                </ul>
        ...
        <div class="row mt-5 mb-5" style="margin-left: 50px; height: 380px">
            <div class="col-5 mt-5">
                <p style="font-size: 2rem; font-weight: bold">맛동산 PC 사이트</p>
                <span style="font-size: 1.2rem;">맛동산 웹사이트의 모든 검색 결과에 노출됩니다.<br>
        ...
        <div class="info-box">
            ...
            <RouterLink to="/QNA/Notice"><button class="btn  btn-outline-secondary mt-5">고객센터 바로가기</button></RouterLink>
        </div>
    </div>
    </template>
