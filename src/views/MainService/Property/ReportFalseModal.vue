            ...
            <div class=" ms-5 me-5">
                <form>
                    ...
                    <div class="row">
                        ...
                        class="col-10" style="height: 100px; font-size: small;" />
                    </div>
                    <hr>
                    <p style=" font-weight: bold;">신고하기전에 확인해주세요!!</p>
                    <div class="row">
                        <input class="col-1" type="checkbox" id="checkbox1">
                    ...
                    <div class="row mt-5">
                        <button class="col btn btn-sm me-5" style="background-color: grey; color: white"> 취소</button>
                        <button class="col btn btn-sm btn-warning">신고하기</button>
                    </div>
                </form>
            </div>
          </div>
