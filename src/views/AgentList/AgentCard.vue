    ...
    <table class="table">
      <thead>
        <tr>
          <th colspan="1">중개인</th>
          <th colspan="2">지역</th>
          <th colspan="2" class="ps-5">고객 리뷰</th>
        </tr>
      </thead>
      <tbody>
        ...
        <tr class="table-line">
          <td colspan="1" class="d-flex align-items-center agent-cell">
            <img
              class="profile-img"
              src="https://photos.zillowstatic.com/h_g/ISq9k7n18szwr41000000000.jpg"
              height="100"
              width="100"
            />
            <div class="col ms-4 me-3 agent-details">
              <h4>이름</h4>
