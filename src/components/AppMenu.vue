    ...
    <div class="container-fluid ms-3">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav pe-5 mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown  me-3 bg-light rounded align-self-center">
            <RouterLink
              class="nav-link dropdown-toggle fw-bold pe-1 ps-1"
              to="#"
              id="navbarDropdown"
              role="button"
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><RouterLink class="dropdown-item" to="/Mypage/MyInfomation">내 정보</RouterLink></li>
              <li><RouterLink class="dropdown-item" to="/Mypage/ManageMyProperty">매물 관리</RouterLink></li>
              <li><RouterLink class="dropdown-item" to="/Mypage/CustomerInquiry">1:1 문의내역</RouterLink></li>
              <li><RouterLink class="dropdown-item" to="/Mypage/ReportFalseListing">허위매물 신고</RouterLink></li>
            </ul>
          </li>          
        </ul>
      </div>
