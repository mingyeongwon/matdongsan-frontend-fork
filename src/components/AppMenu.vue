    ...
    <div class="container-fluid ms-3">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav pe-5 mb-2 mb-lg-0">
          <li class="nav-item dropdown align-self-center me-3 bg-light rounded-pill">
            <RouterLink
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><RouterLink class="dropdown-item" to="#">내 정보</RouterLink></li>
              <li><RouterLink class="dropdown-item" to="#">매물 관리</RouterLink></li>
              <li><RouterLink class="dropdown-item" to="#">허위매물 신고</RouterLink></li>
              <li><RouterLink class="dropdown-item" to="#">1:1 문의내역</RouterLink></li>
              <li><RouterLink class="dropdown-item" to="#">회원탈퇴</RouterLink></li>
            </ul>
          </li>
          <li class="nav-item">
            <button
